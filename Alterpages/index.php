...
<head>
	...
	<script>
		...
		function Validar() {
            ...
            if(confirm('... !Realmente desea REGISTRARSE¡ ...')) {
		...
		function Iniciar() {
            ...
            if(confirm('... !Realmente desea INICIAR SESIÓN¡ ...')) {
    ...
    <div class="container" id="container">
        <div class="Form-container sign-up">
            <form name="inicio" id="inicio" action="../script/guardar.php" method="post">
                ...
                <button type="button" onClick="Validar()">Registrarse</button>
            </form>
        </div>
        <div class="Form-container sign-in">
            <form name="validar" id="validar" action="../script/validar.php" method="post">
                ...
                <input type="email" id="usuario" name="usuario" placeholder="User" title="Digite su usuario">
                <input type="password" id="contrasena" name="contrasena" placeholder="Password" >
                <a href="#">Olvide mi contraseña</a>
                <button type="button" onClick="Iniciar()">Acceder</button>
            </form>
        </div>
